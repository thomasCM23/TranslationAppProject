...
cat "${OUTPUT_DIR_DATA}/europarl-v7-fr-en/europarl-v7.fr-en.en" \
  ...
  "${OUTPUT_DIR_DATA}/nc-v10/news-commentary-v10.fr-en.en" \
  "${OUTPUT_DIR_DATA}/anki/anki.en" \
  > "${OUTPUT_DIR}/train.en"
...
cat "${OUTPUT_DIR_DATA}/europarl-v7-fr-en/europarl-v7.fr-en.fr" \
  ...
  "${OUTPUT_DIR_DATA}/nc-v10/news-commentary-v10.fr-en.fr" \
  "${OUTPUT_DIR_DATA}/anki/anki.fr" \
  > "${OUTPUT_DIR}/train.fr"
...
${OUTPUT_DIR}/mosesdecoder/scripts/ems/support/input-from-sgm.perl \
  ...
  > ${OUTPUT_DIR_DATA}/dev/dev/newstest2014.fr
${OUTPUT_DIR}/mosesdecoder/scripts/ems/support/input-from-sgm.perl \
...
${OUTPUT_DIR}/mosesdecoder/scripts/ems/support/input-from-sgm.perl \
  < ${OUTPUT_DIR_DATA}/dev/dev/newstest2013-ref.fr.sgm \
  > ${OUTPUT_DIR_DATA}/dev/dev/newstest2013.fr
${OUTPUT_DIR}/mosesdecoder/scripts/ems/support/input-from-sgm.perl \
...
${OUTPUT_DIR}/mosesdecoder/scripts/ems/support/input-from-sgm.perl \
  ...
  > ${OUTPUT_DIR_DATA}/test/test/newstest2015.fr
${OUTPUT_DIR}/mosesdecoder/scripts/ems/support/input-from-sgm.perl \
  < ${OUTPUT_DIR_DATA}/test/test/newsdiscusstest2015-enfr-src.en.sgm \
  > ${OUTPUT_DIR_DATA}/test/test/newstest2015.en

# Copy dev/test data to output dir
cp ${OUTPUT_DIR_DATA}/dev/dev/newstest20*.fr ${OUTPUT_DIR}
cp ${OUTPUT_DIR_DATA}/dev/dev/newstest20*.en ${OUTPUT_DIR}
cp ${OUTPUT_DIR_DATA}/test/test/newstest20*.fr ${OUTPUT_DIR}
...
cp "${OUTPUT_DIR}/vocab.bpe.36000" "${OUTPUT_DIR}/vocab.bpe.36000.en"
cp "${OUTPUT_DIR}/vocab.bpe.36000" "${OUTPUT_DIR}/vocab.bpe.36000.fr"
